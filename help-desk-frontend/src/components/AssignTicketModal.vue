...
// --- CORREÇÃO: Busca os analistas ao abrir o modal ---
onMounted(async () => {
  // Força a atualização da lista de técnicos (vai bater no endpoint novo que filtra por equipe)
  await ticketStore.fetchAnalysts()

  // Se houver analistas, seleciona o primeiro por padrão (opcional)
  /*
